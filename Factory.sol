...
contract WalletFactory {
    ...
    function clone(address[] memory _owners, uint _numConfirmationsRequired) external returns (address wallet_addr) {
        ...
        Implementation(newWallet).initialize(_owners, _numConfirmationsRequired);
